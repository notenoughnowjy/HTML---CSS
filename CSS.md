...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/cc37d40c-7cdc-4fb9-8ceb-805f4441c80d/Untitled.png)
...
사용자의 컴퓨터에 설치된 폰트와 사관 없이 **온라인의 특정 서버에 위치한 폰트 파일**을 다운로드하여 화면에 표시해 주는 웹 전용 폰트
...
`Inline 요소의 대표적인 태그는 span태그가 있다.`
